...
local PRE_Commands={
    ...
    drain="Drain any liquid from the world or inventory/tanks in the sides 1, 2, 3, 4 or 5.$&",
    fill="Fill any liquid from world or inventory/tanks in the sides 1, 2, 3, 4 or 5.$&",
    ...
    suck="Sucks any item in any directions or inventorys with a direction 1, 2, 3, 4 or 5. And the Drone try to put in disponible space if can't returns false else returns true.$&",
