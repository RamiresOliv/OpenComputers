...
os.sleep(1)
local success, response = pcall(internet.request, "https://raw.githubusercontent.com/RamiresOliv/OpenComputers/master/Drones/Files/Bios.lua")
if success then
...
os.sleep(1)
local success, response = pcall(internet.request, "https://raw.githubusercontent.com/RamiresOliv/OpenComputers/master/Drones/Files/Client.lua")
if success then
